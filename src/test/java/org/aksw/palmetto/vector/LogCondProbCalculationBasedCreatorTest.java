    ...
    public static Collection<Object[]> data() {
        return Arrays
                .asList(new Object[][] {
                         ...
                         */{
                                3,
                                new double[][] { { 0, 2.0 / 3.0, 2.0 / 3.0, 1.0 / 3.0, 2.0 / 3.0, 1.0 / 3.0,
                                        1.0 / 3.0, 0 } },
                                new double[][][] { { { 0, Math.log(1.0 / 2.0), Math.log(1.0 / 2.0) },
                                { Math.log(1.0 / 2.0), 0, Math.log(1.0 / 2.0) },
                                { Math.log(1.0 / 2.0), Math.log(1.0 / 2.0), 0 } } }, "V_lc" },
                        /*
                         * word1 0 0 0 1
                         * 
                         * word2 0 1 0 1
                         ...
                         */
                        {
                                ...
                                new double[][][] { { { 0, Math.log(1.0 / 2.0), Math.log(1.0 / 2.0) },
                                { 0, 0, Math.log(1.0 / 2.0) }, { 0, Math.log(1.0 / 2.0), 0 } } }, "V_lc" },
                        // all together
                        {
                                3,
                                new double[][] { { 0, 1.0, 2.0 / 3.0, 2.0 / 3.0, 2.0 / 3.0, 2.0 / 3.0, 2.0 / 3.0,
