...
public class NPMICoherenceCalculationTest {
    ...
    public NPMICoherenceCalculationTest(SubsetCreator subsetCreator, int wordsetSize, double[] probabilities,
    ...
    @Test
    public void test() {
        NPMICoherenceCalculation calculation = new NPMICoherenceCalculation(null);
